...
/**
 * Criteria class for the {@link com.dcmc.apps.taskmanager.domain.Priority} entity. This class is used
 * in {@link com.dcmc.apps.taskmanager.web.rest.PriorityResource} to receive all the possible filtering options from
...
public class PriorityCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, visible, createdAt, updatedAt, distinct);
    }
